...
const ASSET_FORMATS = new Set(["image", "file", "video", "audio", "document"]);
...
function legacyFieldToCanonical(
  ...
  if (schema.__amatype === "AmaImageDef" || schema.__amatype === "AmaFileDef") {
    return {
      kind: "asset",
  ...
  if (schema.type === "number" && schema.format === "order") {
    return {
      kind: "order",
      description,
      optional,
  ...
  if (
    ...
    return {
      ...
      generated: true,
      immutable: true,
      source: typeof schema.source === "string" ? schema.source : undefined,
      updatePolicy:
  ...
  if (
    ...
    return {
      ...
      description,
      optional,
      by: schema.by === "slug" || schema.by === "path" ? schema.by : "id",
      targetField:
    ...
    case "reference":
      if (field.multiple)
        return {
          ...base,
          type: "array",
          items: canonicalFieldToLegacy({ ...field, multiple: false }),
        };
      return {
        ...base,
        type: "string",
      ...
      if (field.multiple) {
        return {
          ...
          items: canonicalFieldToLegacy({
            ...
            multiple: false,
            assetKind:
              field.assetKind === "gallery" ? "image" : field.assetKind,
  ...
  if (
    ...
    if (definition.type === "system_config") {
      return {
        ...
        displayName: String(
          definition.displayName || definition.description || name,
        ),
        managedBy:
...
export function compileLegacyStructure(
  ...
  return {
    ...
    mdx: raw.mdx && typeof raw.mdx === "object" ? raw.mdx : {},
    submissions:
      ...
      if (definition.kind === "system_config") {
        ...
        definitions[name] = {
          ...
          structure: {
            type: "object",
            description:
              systemConfig.description || systemConfig.displayName || "",
            properties,
            ...(required.length > 0 ? { required } : {}),
          },
        };
        ...
        (() => {
          ...
          return {
            ...
            fields:
              ...
              typeof submissionInput.fields === "object"
                ? submissionInput.fields
                : {},
            requiresCaptcha:
